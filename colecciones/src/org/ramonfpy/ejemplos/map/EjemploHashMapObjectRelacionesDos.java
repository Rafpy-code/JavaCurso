...
public class EjemploHashMapObjectRelacionesDos {
...
*/
        ...
        for (Map.Entry<String, Object> par : persona.entrySet()) {
            ...
            if (valor instanceof Map) { //Realizar cast a Map<>
                String nombreMap = (String) persona.get("Nombre");
                Map<String, String> direccionMap = (Map<String, String>) valor;

                System.out.println("El país de " + nombreMap + " es " + direccionMap.get("pais"));
                System.out.println("La ciudad de " + nombreMap + " es " + direccionMap.get("ciudad"));
                System.out.println("El barrio de " + nombreMap + " es " + direccionMap.get("barrio"));
            } else {
                System.out.println("Llave: " + par.getKey() + ", Valor -> " + par.getValue());
            }
        }

        System.out.println("=====For anidado=============Map.Entry<String, String> de persona=================");
        for (Map.Entry<String, Object> par : persona.entrySet()) {
            Object valor = par.getValue();
            if (valor instanceof Map) { //Realizar cast a Map<>
                String nombreMap = (String) persona.get("Nombre");
                Map<String, String> direccionMap = (Map<String, String>) valor;
                for (Map.Entry<String, String> parDireccion : direccionMap.entrySet()){
                    System.out.println(parDireccion.getKey() + " -> " + parDireccion.getValue());
                }
            } else {
                System.out.println("Llave: " + par.getKey() + ", Valor -> " + par.getValue());
            }
