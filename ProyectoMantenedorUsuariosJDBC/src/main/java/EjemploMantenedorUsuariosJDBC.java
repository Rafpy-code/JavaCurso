...
public class EjemploMantenedorUsuariosJDBC {

    public static void main(String[] args) {

        // Connection conn -> se reemplaza por ignored porque conn no es usada nunca
        try ( Connection ignored = ConexionBaseDeDatos.getInstance()) {
            ...
            do {
                ...
                if (opcion == null) {
                    ...
                    switch (opcionIndice) {
                        case 1 -> {
                            id = Integer.parseInt(JOptionPane.showInputDialog(null, "Ingresar el id del usuario para Actualizar:"));
                        ...
                        case 2 -> {
                            id = Integer.parseInt(JOptionPane.showInputDialog(null, "Ingresar el id del usuario para eliminar:"));
                        ...
                        case 4 -> repositorio.listar().forEach(System.out::println);
                    }
                }
